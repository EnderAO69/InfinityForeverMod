...
package net.mcreator.infinityforever.world;
...
public class WorldFloorOne extends ElementsInfinityforeverMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldFloorOne(ElementsInfinityforeverMod instance) {
		super(instance, 1);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension floor_one is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("floor_one", "_floor_one", DIMID, WorldProviderMod.class, true);
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("infinityforever:floor_one_biome")),};
